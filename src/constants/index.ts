...
export const MINT_PRICE_LAMPORTS = 10 * 1e9

export const TOTAL_NFTS_MINT = 20_000

export const CANDY_MACHINE_PUBKEY = process.env.CANDY_MACHINE_PUBKEY
export const DESTINATION_PUBKEY = process.env.DESTINATION_PUBKEY
